...
public class GraphDemoFrame extends JFrame {
    ...
    public JTextArea roads;
    private JButton buttonFindCityWithMinRoads;
    private JTextArea outCity;
    ...
    public GraphDemoFrame() {
        ...
        buttonFindCityWithMinRoads.addActionListener(e -> {
            try {
                com.company.Graph.addRoad();
                com.company.Graph.getReachabilityMatrix();
                com.company.Graph.printMatrix(com.company.Graph.getReachabilityMatrix());
                outCity.setText("Город с минимальной суммой путей в доступные города: " + com.company.Graph.cityWithMinWay(com.company.Graph.minWay()));
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textAreaGraphFile.setEditable(true);
        ...
        roads = new JTextArea();
        roads.setText("0 1 40\n1 2 22\n2 3 14\n3 1 6\n3 4 20\n4 1 15\n4 0 18");
        panel1.add(roads, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        buttonFindCityWithMinRoads = new JButton();
        buttonFindCityWithMinRoads.setText("Найти город");
        panel1.add(buttonFindCityWithMinRoads, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        outCity = new JTextArea();
        panel1.add(outCity, new GridConstraints(1, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        ...
        panel8.add(spacer6, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
