...
import program.graphDescription.Graph;
import program.graphDescription.GraphUtils;
    ...
    public GraphDemoFrame() {
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                ...
                Class clz = Class.forName("program.graphDescription." + className);
        ...
        buttonFindCityWithMinRoads.addActionListener(e -> {
            try {
                weightedGraphBuilding.Graph.addRoad();
                weightedGraphBuilding.Graph.getReachabilityMatrix();
                textArea1.setText("Город с минимальной суммой путей в доступные города: " + weightedGraphBuilding.Graph.cityWithMinWay(weightedGraphBuilding.Graph.minWay()));
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
